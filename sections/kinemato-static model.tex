...
\noindent In this thesis, we suppose working with nine actuators, three aerial and six on the ground as  we are interested in working with an over-actuated system. While the ground cables are used to fully control the payload pose, the three drones will act as an anti-gravitational force. A schematic is shown in Figure \ref{fig:6cables3dronesSchem}. The candidate architectures are subsequently evaluated using the performance indices introduced in Section \ref{sec:performanceIndices}.
